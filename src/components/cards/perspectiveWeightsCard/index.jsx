...
const EditPerspectivesForm = ({ setSettings, settings }) => {
    ...
    if (settings.perspective_enabled) {
        ...
        initialValues = { non_perspective_weight: settings?.non_perspective_weight };
     };
    ...
    return (
        <Card className="admin_card">
            ...
            <Form onSubmit={ formik.handleSubmit }>
                {settings?.perspective_enabled? <div>
                ...
                <Form.Group className="mb-3" controlId="non_perspective_weight">
                    <Row>
                        <Col><Form.Label>Other Objectives</Form.Label></Col>      
                        <Col>
                            <Form.Control 
                                type="text" 
                                placeholder="" 
                                { ...formik.getFieldProps('non_perspective_weight') } 
                                isInvalid={ formik.touched.non_perspective_weight && formik.errors.non_perspective_weight }
                            />
                            <Form.Control.Feedback type='invalid'>
                                { formik.errors.non_perspective_weight }
                            </Form.Control.Feedback>
                        </Col>
                    </Row>
                </Form.Group>
