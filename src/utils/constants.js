...
export const ACTION_SUCCESSFUL_MESSAGE = "Action Sucessful";
...
export const FIN_FIRST_PERSPECTIVES_ORDER_ARRAY = [
    FINANCIAL,
    CUSTOMER,
    INTERNAL_PROCESSES,
    LEARNING_GROWTH
...
export const CUST_FIRST_PERSPECTIVES_ORDER_ARRAY = [
    CUSTOMER,
    FINANCIAL,
    INTERNAL_PROCESSES,
    LEARNING_GROWTH
